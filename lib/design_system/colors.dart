...
class AppColors {
  ...
  static const Color point800 = Color(0xFFF56711);
  static const Color point700 = Color(0xFFFD7A2A);
  static const Color point600 = Color(0xFFFD975A);
  static const Color point500 = Color(0xFFFFBA91);

  // Grey Colors
  static const Color grey900 = Color(0xFF1B1C1A);
  static const Color grey800 = Color(0xFF333533);
  static const Color grey700 = Color(0xFF474846);
  static const Color grey600 = Color(0xFF5C5D5B);
  static const Color grey500 = Color(0xFF737772);
  static const Color grey400 = Color(0xFF929690);
  static const Color grey300 = Color(0xFFB7BAB6);
  static const Color grey200 = Color(0xFFD9DDD7);
  static const Color grey100 = Color(0xFFEBEDEA);
  static const Color grey50 = Color(0xFFF3F5F2);
